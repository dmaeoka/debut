...
export default class Slideshow {
	...
	_setupTouchEvents() {
		// this.touchEvents = new TouchEvents(this.sliderTrack, {
		// 	start: function() {
		// 		this._onTouchStart();
		// 	}.bind(this),
	...
	_onTouchMove(event, direction, difference) {
	...
	_onTouchEnd(event, direction, difference) {
	 ...
	 */
	_setupMultipleActiveSlide(minIndex, maxIndex) {
		this.slides.forEach(function(slide) {
	 ...
	 */
	_verifyFirstLastSlideTranslateX(translateXValue) {
		// first slide
	...
	_isNextTranslateXFirst(translateXValue) {
		return translateXValue === 0;
	}

	_isNextTranslateXLast(translateXValue) {
